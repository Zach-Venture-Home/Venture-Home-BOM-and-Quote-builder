...
const noMarkupQuote=total([{item:'Panel',category:'Equipment',cost:1000,qty:1}],0);
assert.equal(noMarkupQuote.beforeMarkup,1000);
assert.equal(noMarkupQuote.markupAmount,0);
assert.equal(noMarkupQuote.grand,1000);
